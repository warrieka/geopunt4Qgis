...
#
# Created: Sat Jan 18 14:31:56 2014
...
class Ui_batchGeocodeDlg(object):
    def setupUi(self, batchGeocodeDlg):
        ...
        batchGeocodeDlg.resize(558, 456)
        ...
        self.gridLayout.addWidget(self.zoomToSelBtn, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.validateSelBtn, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.outPutTbl, 0, 0, 4, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/geopunt4Qgis/images/qgis-icon-16x16.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddValidToMap.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/geopunt4Qgis/images/all.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionValidateAll.setIcon(icon4)
