...
#
# Created: Wed Jan 22 13:46:36 2014
...
class Ui_batchGeocodeDlg(object):
    def setupUi(self, batchGeocodeDlg):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/geopunt4Qgis/images/geopuntReverse.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.adresFromMapAction.setIcon(icon6)
    ...
    def retranslateUi(self, batchGeocodeDlg):
        ...
        self.label.setText(QtGui.QApplication.translate("batchGeocodeDlg", "(Optioneel) Gemeente kolom:", None, QtGui.QApplication.UnicodeUTF8))
