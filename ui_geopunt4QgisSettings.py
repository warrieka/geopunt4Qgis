...
#
# Created: Thu Feb 27 21:56:54 2014
...
class Ui_settingsDlg(object):
    def setupUi(self, settingsDlg):
        ...
        self.settingsTab.addItem(self.generalTab, icon, _fromUtf8(""))
        self.adresTab = QtGui.QWidget()
        self.adresTab.setGeometry(QtCore.QRect(0, 0, 440, 232))
        ...
        self.reverseTab.setGeometry(QtCore.QRect(0, 0, 440, 232))
        ...
        self.batchgeoCodeTab.setGeometry(QtCore.QRect(0, 0, 440, 232))
        ...
        self.poiTab.setGeometry(QtCore.QRect(0, 0, 440, 232))
        ...
        self.gipodTab.setGeometry(QtCore.QRect(0, 0, 440, 232))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/geopunt4Qgis/images/geopuntGIPODsmall.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.settingsTab.addItem(self.gipodTab, icon5, _fromUtf8(""))
