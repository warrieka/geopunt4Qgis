...
#
# Created: Fri Jan 31 00:12:22 2014
...
class Ui_gipodDlg(object):
    def setupUi(self, gipodDlg):
        ...
        gipodDlg.setMinimumSize(QtCore.QSize(0, 332))
        gipodDlg.setMaximumSize(QtCore.QSize(16777215, 332))
        icon = QtGui.QIcon()
    ...
    def retranslateUi(self, gipodDlg):
        ...
        self.outputFile.setPlaceholderText(_translate("gipodDlg", "output bestand", None))
        self.openFileBtn.setText(_translate("gipodDlg", "Open", None))
